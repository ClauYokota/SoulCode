...
public class ChamadoController {
    ...
    //definindo o endpoint para o serviço de cadastro de um novo chamado
    ...
    //mapeamento do método de atribuir um funcionario a um determinado chamado
    ...
    //mapeamento do método para modificar o status de um chamado
